...
KEY_MODS = Mods.KEY1 | Mods.KEY2 | Mods.KEY3 | Mods.KEY4 | Mods.KEY5 | Mods.KEY6 | Mods.KEY7 | Mods.KEY8 | Mods.KEY9
...
SCORE_INCREASE_MODS = Mods.HIDDEN | Mods.HARDROCK | Mods.FADEIN | Mods.DOUBLETIME | Mods.FLASHLIGHT
