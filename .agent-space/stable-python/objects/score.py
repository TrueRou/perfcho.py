...
class Score:
    ...
    def calculate_accuracy(self) -> float:
        ...
        if mode_vn == 0:  # osu!
            ...
            return 100.0 * ((self.n300 * 300.0) + (self.n100 * 100.0) + (self.n50 * 50.0)) / (total * 300.0)
            ...
            total = self.n300 + self.n100 + self.n50 + self.ngeki + self.nkatu + self.nmiss
            ...
            return (
                100.0
                * ((self.n50 * 50.0) + (self.n100 * 100.0) + (self.nkatu * 200.0) + ((self.n300 + self.ngeki) * 300.0))
                / (total * 300.0)
            )
        else:
    ...
    async def increment_replay_views(self) -> None:
        ...
        await app.state.services.database.execute(
            "UPDATE stats SET replay_views = replay_views + 1 WHERE id = :user_id AND mode = :mode",
